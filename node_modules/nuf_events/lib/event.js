var Event = (function(){
	...
	Event.appInit = function(app){
		if(!app.nuf_eventsAppInitiated){
			var 
				eventsClientPath = require("path").resolve(__dirname+"/../src/eventsClient.js"),
				eventsClientUrl = "/eventsClient.js";
            log(
                "nuf_events adding app url..\n"+
                "eventsClientUrl :"+eventsClientUrl+"\n"+
                "eventsClientPath:"+eventsClientPath
            );
            app.use (eventsClientUrl, require("express").static(eventsClientPath) );
			app.nuf_eventsAppInitiated = true;
		}
	};
    return Event;
